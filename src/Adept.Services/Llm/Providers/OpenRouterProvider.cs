...
namespace Adept.Services.Llm.Providers
{
    ...
    public class OpenRouterProvider : ILlmProvider
    {
        ...
        public Task<bool> SetModelAsync(string modelId)
        {
            ...
            {
                _currentModel = model;
                _logger.LogInformation("OpenRouter model set to {ModelName}", model.Name);
                return Task.FromResult(true);
            }

            _logger.LogWarning("OpenRouter model {ModelId} not found", modelId);
        ...
        public async Task<LlmResponse> SendMessagesAsync(IEnumerable<LlmMessage> messages, string? systemPrompt = null, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                client.DefaultRequestHeaders.Add("HTTP-Referer", "https://adept.ai");
                client.DefaultRequestHeaders.Add("X-Title", "ADEPT AI Teaching Assistant");
                ...
                _logger.LogInformation("OpenRouter response received");
                return llmResponse;
            }
            catch (Exception ex)
            {
        ...
        public async Task<LlmResponse> SendMessagesStreamingAsync(IEnumerable<LlmMessage> messages, Action<string> onChunk, string? systemPrompt = null, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                _logger.LogInformation("OpenRouter streaming response completed");
                return llmResponse;
            }
            catch (Exception ex)
            {
        ...
        public async Task<LlmResponse> SendMessageWithImageAsync(string message, byte[] imageData, string? systemPrompt = null, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                _logger.LogInformation("OpenRouter vision response received");
                return llmResponse;
            }
            catch (Exception ex)
            {
                _logger.LogError(ex, "Error sending message with image to OpenRouter");
                throw;
            }
        }
        ...
        public async Task<LlmResponse> SendMessagesWithToolsAsync(IEnumerable<LlmMessage> messages, IEnumerable<LlmTool> tools, string? systemPrompt = null, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                _logger.LogInformation("OpenRouter response with tools received");
                return llmResponse;
            }
            catch (Exception ex)
            {

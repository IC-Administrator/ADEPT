...
namespace Adept.GoogleCalendar.ManualTests
{
    /// <summary>
    /// Manual tests for Google Calendar integration
    /// </summary>
    class Program
    {
        ...
        private static GoogleCalendarService _calendarService = null!;
        private static ISecureStorageService _secureStorageService = null!;

        static async Task Main(string[] args)
        {
            Console.WriteLine("Adept Google Calendar Manual Tests");
            Console.WriteLine("=================================");
            ...
            _calendarService = _serviceProvider.GetRequiredService<GoogleCalendarService>();
            ...
            while (!exit)
            {
                ...
                Console.WriteLine("4. Test Recurring Events");
                Console.WriteLine("5. Test Calendar Sync");
        ...
        /// <summary>
        /// Test authentication with Google Calendar
        /// </summary>
        ...
        private static async Task TestCalendarOperationsAsync()
        {
            ...
            var testCalendar = await _calendarService.CreateCalendarAsync(new CalendarInfo
            {
                ...
                Description = "This is a test calendar created by the Adept Google Calendar Manual Tests."
            });
        ...
        private static async Task TestEventOperationsAsync()
        {
            ...
            var testEvent = await _calendarService.CreateEventAsync(primaryCalendar.Id, new EventInfo
            {
                ...
                Description = "This is a test event created by the Adept Google Calendar Manual Tests.",
        ...
        /// <summary>
        /// Ensure that we're authenticated with Google Calendar
        /// </summary>
